# orders.py
# The orders update endpoint now extracts the third_party flag from the request.
# When third_party is True, the updated order document will include additional fields
# (such as sent_to_3rd_party and third_party) to indicate that the order was sent to a vendor.
...
def update_order_status():
    try:
        ...
        # New: extract the third_party flag from the request (defaulting to False)
        ...
        # Pass the third_party flag to the DAL method
